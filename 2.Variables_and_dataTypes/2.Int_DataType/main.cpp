...
int main()
{
    ...
    int domisticated_animals{dog_count + cat_count};

    std::cout << "Elephant count : " << elephant_count << std::endl;
    std::cout << "Lion count : " << lion_count << std::endl;
    std::cout << "Dog count : " << dog_count << std::endl;
    std::cout << "Cat count : " << cat_count << std::endl;
    std::cout << "Domisticated animals : " << domisticated_animals << std::endl;
    */
    ...
    std::cout << "Norrowing conversion assignment : " << narrowing_conversion_assignment << std::endl;

    // chech the size with sizeof
